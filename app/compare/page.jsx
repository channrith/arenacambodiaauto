                    ...
                    <div className="compare">
                        ...
                        <div className="compare__features">
                            ...
                            <div className="feature-row">
                                ...
                                <div className="feature-col">2021, October</div>
                            </div>
                            ...
                            <div className="feature-row">
                                ...
                                <div className="feature-col">Available to order. Released 2022</div>
                            </div>

                            <div className="feature-row">
                                <div className="feature-col feature-label"><strong>Base price</strong></div>
                        ...
                        <div className="compare__features">
                            ...
                            <div className="feature-row">
                                ...
                                <div className="feature-col">FWD 130 kw (177 hp)</div>
                            </div>
                            ...
                            <div className="feature-row">
                                ...
                                <div className="feature-col"></div>
                                <div className="feature-col">280 Nm (207 lb-ft)</div>
                            </div>
                            ...
                            <div className="feature-row">
                                ...
                                <div className="feature-col">8.3 sec 0-100 km/h</div>
                            </div>
                            ...
                            <div className="feature-row">
                                ...
                                <div className="feature-col">185 km/h (115 mph)</div>
                            </div>
                        </div>
